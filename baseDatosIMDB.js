...
movie1.actors = [person1.nombre, person3.nombre, person4.nombre];
movie1.director = person2.nombre;
movie1.writer = person5.nombre;
...
movie2.actors = [person1.nombre, person3.nombre, person4.nombre];
movie2.director = person2.nombre;
movie2.writer = person5.nombre;
...
movie3.actors = [person1.nombre, person3.nombre, person4.nombre];
movie3.director = person2.nombre;
movie3.writer = person5.nombre;
...
movie4.actors = [person1.nombre, person3.nombre, person4.nombre];
movie4.director = person2.nombre;
movie4.writer = person5.nombre;
...
movie5.actors = [person1.nombre, person3.nombre, person4.nombre];
movie5.director = person2.nombre;
movie5.writer = person5.nombre;
...
movie6.actors = [person1.nombre, person3.nombre, person4.nombre];
movie6.director = person2.nombre;
movie6.writer = person5.nombre;
...
movie7.actors = [person1.nombre, person3.nombre, person4.nombre];
movie7.director = person2.nombre;
movie7.writer = person5.nombre;
...
movie8.actors = [person1.nombre, person3.nombre, person4.nombre];
movie8.director = person2.nombre;
movie8.writer = person5.nombre;
...
movie9.actors = [person1.nombre, person3.nombre, person4.nombre];
movie9.director = person2.nombre;
movie9.writer = person5.nombre;
...
movie10.actors = [person1.nombre, person3.nombre, person4.nombre];
movie10.director = person2.nombre;
movie10.writer = person5.nombre;
...
function mostrarDetalles(){
     document.getElementById("detallesPeli1").innerHTML = movie1

     document.getElementById("fotoPeli1").src = movie1.foto

}

function ocultarDetalles(){
    document.getElementById("detallesPeli1").innerHTML = ""
    document.getElementById("fotoPeli1").src = ""
...
function mostrarDetalles2()
{
    ...
    document.getElementById("detallesPeli2").innerHTML = movie2

     document.getElementById("fotoPeli2").src = movie2.foto
}

function ocultarDetalles2(){
    document.getElementById("detallesPeli2").innerHTML = ""
    document.getElementById("fotoPeli2").src = ""
}
...
function mostrarDetalles3()
{
    ...
    document.getElementById("detallesPeli3").innerHTML = movie3

     document.getElementById("fotoPeli3").src = movie3.foto
}
function ocultarDetalles3(){
    document.getElementById("detallesPeli3").innerHTML = ""
    document.getElementById("fotoPeli3").src = ""
}
...
function mostrarDetalles4()
{
    ...
    document.getElementById("detallesPeli4").innerHTML = movie4

     document.getElementById("fotoPeli4").src = movie4.foto
}
function ocultarDetalle4(){
    document.getElementById("detallesPeli4").innerHTML = ""
    document.getElementById("fotoPeli4").src = ""
}

function mostrarDetalles5()
{

    document.getElementById("detallesPeli5").innerHTML = movie5

     document.getElementById("fotoPeli5").src = movie5.foto
}

function ocultarDetalles5(){
    document.getElementById("detallesPeli5").innerHTML = ""
    document.getElementById("fotoPeli5").src = ""
}

function mostrarDetalles6()
{

    document.getElementById("detallesPeli6").innerHTML = movie6

     document.getElementById("fotoPeli6").src = movie6.foto
}

function ocultarDetalle6(){
    document.getElementById("detallesPeli6").innerHTML = ""
    document.getElementById("fotoPeli6").src = ""
}

function mostrarDetalles7()
{

    document.getElementById("detallesPeli7").innerHTML = movie7

     document.getElementById("fotoPeli7").src = movie7.foto
}

function ocultarDetalles7(){
    document.getElementById("detallesPeli7").innerHTML = ""
    document.getElementById("fotoPeli7").src = ""
}

function mostrarDetalles8()
{

    document.getElementById("detallesPeli8").innerHTML = movie8

     document.getElementById("fotoPeli8").src = movie8.foto
}

function ocultarDetalles8(){
    document.getElementById("detallesPeli8").innerHTML = ""
    document.getElementById("fotoPeli8").src = ""
}
...
function mostrarDetalles9()
{
    ...
    document.getElementById("detallesPeli9").innerHTML = movie9

     document.getElementById("fotoPeli9").src = movie9.foto
}

function ocultarDetalles9(){
    document.getElementById("detallesPeli9").innerHTML = ""
    document.getElementById("fotoPeli9").src = ""
}

function mostrarDetalles10()
{

    document.getElementById("detallesPeli10").innerHTML = movie10

     document.getElementById("fotoPeli10").src = movie10.foto
}

function ocultarDetalles10(){
    document.getElementById("detallesPeli1").innerHTML = ""
    document.getElementById("fotoPeli1").src = ""
}
